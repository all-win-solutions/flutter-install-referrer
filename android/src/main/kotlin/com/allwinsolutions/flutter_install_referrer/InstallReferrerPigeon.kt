...
data class IRInstallationReferrer(
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is IRInstallationReferrer) {
      return false
    }
    if (this === other) {
      return true
    }
    return InstallReferrerPigeonPigeonUtils.deepEquals(toList(), other.toList())
  }
        ...
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.detectReferrer { result: Result<IRInstallationReferrer> ->
              ...
              if (error != null) {
                reply.reply(InstallReferrerPigeonPigeonUtils.wrapError(error))
              } else {
                val data = result.getOrNull()
                reply.reply(InstallReferrerPigeonPigeonUtils.wrapResult(data))
              }
            }
          }
        } else {
